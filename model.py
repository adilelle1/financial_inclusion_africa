...
# Pagina 3 = Comparación de modelos
    ...
    def model_backstage():
        ...
        st.write('Por este motivo, al comparar el modelo utilizando resampleo, como vemos que los falsos positivos aumentan decidimos mantener el modelo con clases desbalanceadas.')

...
# Pagina 2 = Graficos
    ...
    def graf_hist_by_feature():
        fig = px.histogram(df, x= ['bank_account'], facet_col=['bank_account'], color= col_hist_by_feat,  color_discrete_sequence=px.colors.qualitative.Set2).update_xaxes(categoryorder='total descending',)
        fig.update_layout(
            autosize=False,
            width=1000,
            height=600,
